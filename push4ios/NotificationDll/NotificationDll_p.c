...
/* Object interface: INotify, ver. 0.0,
   GUID={0x9FD8910B,0x01BF,0x40F1,{0xB3,0x8C,0x93,0x66,0x11,0xC8,0xDF,0xC2}} */
...
CINTERFACE_PROXY_VTABLE(10) _INotifyProxyVtbl = 
{
    &INotify_ProxyInfo,
    &IID_INotify,
    ...
    (void *)-1 /* INotify::start */ ,
    (void *)-1 /* INotify::stop */ ,
    (void *)-1 /* INotify::set_cb */
};
...
const CInterfaceProxyVtbl * _NotificationDll_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_INotifyProxyVtbl,
    0
};

const CInterfaceStubVtbl * _NotificationDll_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_INotifyStubVtbl,
    0
};

PCInterfaceName const _NotificationDll_InterfaceNamesList[] = 
{
    "INotify",
    0
};

const IID *  _NotificationDll_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _NotificationDll_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _NotificationDll, pIID, n)

int __stdcall _NotificationDll_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_NotificationDll_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo NotificationDll_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _NotificationDll_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _NotificationDll_StubVtblList,
    (const PCInterfaceName * ) & _NotificationDll_InterfaceNamesList,
    (const IID ** ) & _NotificationDll_BaseIIDList,
    & _NotificationDll_IID_Lookup, 
    1,
    2,
