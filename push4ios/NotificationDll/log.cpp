...
// 3.默认日志级别 debug
// 4.双缓冲写文件
//  author:张世光 2011.7  87895224@QQ.com
// 
//////////////////////////////////////////////////////////////////////
...
void LogExt(int loglevel,const char* lpszFormat,...)
{
	...
	{
		writelogimmediatly("[exception][LogExt]!\n");
		exceptiontolog(e);		
...
{	
	...
	{		
		writelogimmediatly("CreateFileMapping fail!\n");
		return;
	}
...
bool Clog::log(const char* msg,int loglevel)
{
	...
	{
		writelogimmediatly("CClientlog::log except!\n");
		exceptiontolog(e);
	}
#else
	DEBUGOUT(msg);
