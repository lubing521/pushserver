// senderserver.cpp : Implementation of WinMain


// Note: Proxy/Stub Information
//      To build a separate proxy/stub DLL, 
//      run nmake -f senderserverps.mk in the project directory.
...
inline HRESULT CServiceModule::UnregisterServer()
{
    ...
    UpdateRegistryFromResource(IDR_Senderserver, FALSE);
    // Remove service
    Uninstall();
